...
static enum sha256_algos opt_algo = ALGO_GROESTL;
...
int main(int argc, char *argv[])
{
	...
	printf("\xBA  GroestlCoin cpu-miner (v1.0a)                   \xBA\n");
	printf("\xBA  author: ig0tik3d                                \xBA\n");
	printf("\xBA                                                  \xBA\n");
